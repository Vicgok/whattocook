...
const pantry: PantryItem[] = [
  { id: "1", userId: "u", ingredientId: "rice", createdAt: "", updatedAt: "" },
];
...
expect(
  ...
  "required ingredient score is deterministic",
);
expect(
  match.missingIngredients.length === 1 &&
    match.missingIngredients[0]?.ingredientId === "egg",
  "missing required ingredient is reported",
);
...
expect(
  ordered[0]?.title === "First",
  "database step numbers are ordered ascending",
);
expect(
